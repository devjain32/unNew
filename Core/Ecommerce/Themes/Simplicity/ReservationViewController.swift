...
class ReservationViewController: UIViewController {
    ...
    private func configureUI() {
        ...
        nameLabel.font = uiEcommerceConfig.regularLargeSizeFont

        descriptionLabel.text = shop.streetAddress
        descriptionLabel.textColor = uiEcommerceConfig.subtitleLabelColor
        descriptionLabel.font = uiEcommerceConfig.regularSmallSizeFont
        ...
        reserveButton.backgroundColor = uiEcommerceConfig.mainButtonBackgroundColor
        reserveButton.setTitleColor(.white, for: .normal)
        reserveButton.layer.cornerRadius = 5
        reserveButton.titleLabel?.font = uiEcommerceConfig.productDetailsAddToCartButtonFont
