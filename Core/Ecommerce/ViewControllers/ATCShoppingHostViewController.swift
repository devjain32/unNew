...
class ATCShoppingHostViewController: UIViewController, UITabBarControllerDelegate {
    ...
    init(configuration: ATCEcommerceConfiguration,
        ...
        self.reservationVC = ATCReservationViewControllerFactory().reservationVC(shop: MockStore.shop, serverConfig: serverConfig, uiEcommerceConfig: uiEcommerceConfig)
